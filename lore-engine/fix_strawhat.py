...
def process():
    directory = "raw/gs2/_chapters/strawhat"
    for filename in sorted(os.listdir(directory)):
        ...
        if filename == "00-front.md" or is_header_only:
            ...
            covers = []
            region = ""
        elif toc.startswith("3.0 > ") or toc == "3.0" or toc.startswith("4.0 > ") or toc == "4.0":
            # Walkthrough areas
            ...
            covers = ["items"]
            region = ""
        elif toc.startswith("10.0 > ") or toc == "10.0":
            kind = "data-table"
            covers = ["equipment"]
            region = ""
        elif toc == "11.0":
            ...
            covers = ["forging"]
            region = ""
        elif any(toc.startswith(x) for x in ["1.0", "2.0", "12.0", "13.0", "14.0"]):
            kind = "meta"
            covers = []
            region = ""
        else:
