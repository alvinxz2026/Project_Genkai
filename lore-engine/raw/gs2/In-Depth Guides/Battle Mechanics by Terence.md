...
source_id: terence
author: Terence
url: https://gamefaqs.gamespot.com/gba/561356-golden-sun-the-lost-age/faqs/22880
type: mechanics
covers: [mechanics, classes, psynergy, djinn, summons, equipment, forging]
quality: high
summary: Highest Rated 战斗机制权威源（职业系统/base stats/djinn 加成/elemental levels/职业需求与加成/伤害公式/武器解放/djinn&summon&psynergy 机制/道具使用）。偏机制，非数值表。
gs1_counterpart: Djinn Class Mechanics FAQ - Terence.txt
notes: 原文中有table of contents, 但是是用line reference，贴过来肯定不对，所以我把line reference删了。这篇挺牛逼的，是个Highest Rated Guide。
---

# Battle Mechanics by Terence
