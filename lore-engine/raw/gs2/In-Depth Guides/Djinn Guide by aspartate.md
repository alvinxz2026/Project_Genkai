---
source_id: aspartate-djinn
author: aspartate
url: https://gamefaqs.gamespot.com/gba/561356-golden-sun-the-lost-age/faqs/23017
type: faq
covers: [djinn, locations, transfer]
quality: default
summary: djinn 获取（按获得顺序 + 按元素），并标出哪些不靠 GS1 transfer 即可拿。比 Android50 详细。
gs1_counterpart:
notes: 比另一篇详细
---

# Djinn Guide by aspartate
...
***************************Golden Sun: The Lost Age**************************
                                English Version Djinn Guide
                        By Aspartate (shiningshizuko@hotmail.com)
                        Version 1.2 , Last update on Sept 19, 2003
*****************************************************************************
...
However, the "checkpoint" should be useful.
...
Stand beside the statue and use "Tremor" to shake it back and forth.
...
10. Balm (Thalasso, this means "ocean" in Greek)
    Solve the ice puzzle in Mars Lighthouse. (Hint: the statue)
11. Serac (Zero)
...
This is a chance for players to make up for their mistakes,
 not for some "bonus" or whatsoever.
...
Because "Update" can be done anytime before Isaac joins,
