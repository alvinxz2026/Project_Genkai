---
source_id: torrentlord
author: torrentlord
url: https://gamefaqs.gamespot.com/gba/561356-golden-sun-the-lost-age/faqs/29414
type: data-table
covers: [monsters, bosses, locations, items]
quality: high
summary: Highest Rated 敌人数据库（每只 HP/PP/Att/Def/Agil/Luck/turns + 四元素 power&resist + abilities + reward(EXP/coins/掉落含 ICC) + location），并附按各属性排序表。monsters/bosses 提取首选数据源。
gs1_counterpart: Comprehensive Enemy List - Torrent Load.txt
notes: Highest Rated Guide; 大量数据
---

# Enemy and Boss List by torrentlord
