...
available_to            array of object   YES        One object per character who can take this
  ...
  [].djinn_requirements array of object   YES        Djinn setups per source. Sources express
    ...
    [].parsed           array of object   YES        Structured form of `requirement`, generated by
                                                     scripts/links_normalize.py. Element names are
                                                     normalized (Venus->earth, Mars->fire, etc).
                                                     [] when the prose has no element-count (e.g.
                                                     Jenna's fixed class note).
